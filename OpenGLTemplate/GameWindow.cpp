...
void GameWindow::operator=(const GameWindow& newWindow)
{
	m_fullscreen = newWindow.m_fullscreen;
	m_hdc = newWindow.m_hdc;
	m_hinstance = newWindow.m_hinstance;
	m_hrc = newWindow.m_hrc;
	m_hwnd = newWindow.m_hwnd;
	m_class = newWindow.m_class;
	m_dimensions = newWindow.m_dimensions;
	m_appName = newWindow.m_appName;
}
